...
function btn1() {
  window.open(
    "https://www.naver.com",
    "네이버",
    "width=500,height=600,resizalble=no,location=no,menubar=no,scrollbars=no,status=no,toolbar=no"
  );
}
function btn2() {
  let newWindow = open();
